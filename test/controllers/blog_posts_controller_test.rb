...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { authorname: @blog_post.authorname, commenttext: @blog_post.commenttext, posttext: @blog_post.posttext, posttitle: @blog_post.posttitle }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { authorname: @blog_post.authorname, commenttext: @blog_post.commenttext, posttext: @blog_post.posttext, posttitle: @blog_post.posttitle }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
